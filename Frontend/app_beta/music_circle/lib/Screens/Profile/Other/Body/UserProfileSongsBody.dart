...
class UserProfileSongsBody extends StatelessWidget {
  const UserProfileSongsBody({Key key}) : super(key: key);
      ...
      children: [
        ...
        children: [
          Material(
            ...
            Positioned(
                top: 70,
                child: UserProfileSongCategories()
            ),
          ]
        ),
      ],
...
class UserProfileSongCategories extends StatelessWidget {
  const UserProfileSongCategories({Key key}) : super(key: key);
