...
class ProfileAppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SliverPersistentHeader(
      delegate: UserProfileAppBarDelegate(expandedHeight: size.height * 0.55, minHeight: minHeight),
      pinned: true,
    );
  }
}
...
class UserProfileAppBarDelegate extends SliverPersistentHeaderDelegate{
  final double expandedHeight, minHeight;

  UserProfileAppBarDelegate({@required this.expandedHeight, @required this.minHeight});
  ...
  Widget build(BuildContext context, double shrinkOffset, bool overlapsContent) {
    ...
    int bodyIndex = UserProfileInherited.of(context).state.bodyIndex;
    ...
    return Stack(
      ...
      children: [
        ...
        Positioned(
          ...
          left: min(top, size.height*0.1 - shrinkOffset - kToolbarHeight),
        ...
        Positioned(
            top: min(top, size.height*0.1 - shrinkOffset - kToolbarHeight) + size.height * 0.135,
            right: 0,
            child: Padding(
        ...
        Positioned(
          top: getFollowButtonTopPosition(bodyIndex, size, top, shrinkOffset),
          right: 5,
          child: buildFollowButton(shrinkOffset, context),
        ),
      ],
    );
  }
